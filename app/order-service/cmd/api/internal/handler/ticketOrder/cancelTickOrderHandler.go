...
func CancelTickOrderHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := ticketOrder.NewCancelTickOrderLogic(r.Context(), svcCtx)
		resp, err := l.CancelTickOrder(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
