...
type TrainStationQueryRespDTO struct {
	...
	// *
	// 出发时间
	DepartureTime int64 `protobuf:"varint,4,opt,name=departureTime,proto3" json:"departureTime,omitempty"`
	// *
	// 停留时间
...
func (x *TrainStationQueryRespDTO) GetArrivalTime() int64 {
	if x != nil {
...
func (x *TrainStationQueryRespDTO) GetDepartureTime() int64 {
	if x != nil {
...
var file_ticket_proto_rawDesc = []byte{
	...
	0x6c, 0x54, 0x69, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0b, 0x61, 0x72, 0x72,
	0x69, 0x76, 0x61, 0x6c, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x24, 0x0a, 0x0d, 0x64, 0x65, 0x70, 0x61,
	0x72, 0x74, 0x75, 0x72, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52,
